...
% ====================== SPRINT 0: INFRAESTRUCTURA, ENTORNO Y REPRODUCIBILIDAD ====================
...
% ====================== SPRINT 1: PREPROCESAMIENTO Y REFINAMIENTO DE DATOS ====================
...
\begin{itemize}
    ...
    \item \textbf{Clase 1 (Positivo):} WSIs con Gleason Score $\ge 6$ (G3, G4, G5), acorde con definiciones clínicas \cite{epstein2016gleason} \cite{SILVARODRIGUEZ2020105637}.
\end{itemize}
...
% ====================== SPRINT 2: INGENIERÍA DE CARACTERÍSTICAS Y PREVENCIÓN DE FUGA DE DATOS ====================
...
% ====================== SPRINT 3: MODELADO MIL Y VALIDACIÓN ====================
...
% ====================== SPRINT 4: INTERPRETACIÓN Y MAPAS DE ATENCIÓN ====================
...
% ====================== SPRINT 5: AJUSTE FINAL Y OPTIMIZACIÓN
...
Con el fin de garantizar la coherencia entre los objetivos específicos del proyecto, los requisitos funcionales definidos y los componentes implementados en el pipeline experimental, se establece la matriz de trazabilidad presentada en la Tabla~\ref{tab:trazabilidad}. Esta matriz permite verificar que cada objetivo del sistema se encuentra respaldado por decisiones técnicas concretas y plenamente implementadas en el desarrollo experimental.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|}
        \hline
        \textbf{Objetivo Específico} & \textbf{Requisitos Funcionales} & \textbf{Componente del Pipeline} \\
        \hline
