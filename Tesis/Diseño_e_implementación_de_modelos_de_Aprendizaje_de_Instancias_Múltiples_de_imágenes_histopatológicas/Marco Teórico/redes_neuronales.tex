...
Una estrategia comúnmente adoptada en aplicaciones de histopatología digital es el uso de \textbf{transfer learning}, donde arquitecturas de CNN pre-entrenadas en conjuntos de datos extensos como ImageNet son adaptadas para tareas específicas de clasificación o extracción de características sobre parches de tejido \cite{DLDigitalPathologySurvey2020} \cite{HistopathologyCNNFeatures2017}.  
