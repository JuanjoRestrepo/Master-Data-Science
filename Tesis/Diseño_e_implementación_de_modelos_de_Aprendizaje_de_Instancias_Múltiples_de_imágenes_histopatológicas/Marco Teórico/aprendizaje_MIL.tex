...
\begin{figure}[ht!]
    \centering
    %\includegraphics[width=15cm, height=7.25cm]{images/Esquema_Ejemplo_MIL3.png}
    \includegraphics[width=0.8\textwidth]{images/Esquema_Ejemplo_MIL_OLD.png}
