...
Este examen produce la asignación de un \textbf{puntaje de Gleason}, un sistema de gradación que clasifica la agresividad tumoral con base en la arquitectura glandular observada en las muestras \cite{Brett_2016} \cite{Ozkan2016}. \newline
...
Esta información se resume y agrupa en categorías clínicamente relevantes definidas por la \textbf{International Society of Urological Pathology (ISUP)} \cite{SILVARODRIGUEZ2020105637} \cite{epstein2016gleason}.\newline
...
A pesar de la importancia clínica de la gradación de Gleason, su asignación presenta variabilidad \textbf{interobservador} significativa, incluso entre patólogos experimentados \cite{Brett_2016} \cite{Ozkan2016} \cite{GleasonInterobserverPubMed2023}. Dicha variabilidad es especialmente notoria en la distinción entre \textbf{Gleason 3 y Gleason 4} y en la identificación de patrones con riesgo clínico intermedio o alto, lo que genera retos en la reproducibilidad y consistencia diagnóstica.\newline
...
Estas limitaciones han motivado la adopción de técnicas computacionales avanzadas, particularmente en aprendizaje profundo, para apoyar la evaluación histopatológica y mejorar la reproducibilidad diagnóstica. Las arquitecturas de \textbf{Multiple Instance Learning} (MIL), junto con mecanismos de atención, se presentan como soluciones naturales para integrar supervisión débil con representación de patrones discriminativos en WSIs.\newline
