-- Query A:
-- Listar todos los cursos ofrecidos en la carrera de Ingenier�a de
...
-- del curso, el nombre completo del profesor que dicta el curso, el sal�n
...
WHERE
    fac.nombre LIKE '%Humanidades%'  -- Aqu� usamos el nombre para mayor legibilidad
ORDER BY
...
-- la que pertenece el curso. Pista: averigua c�mo funciona la sentencia WITH.
